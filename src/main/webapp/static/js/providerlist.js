...
function deleteProvider(obj){
	$.ajax({
		type:"GET",
		url:path+"/jsp/deleteprovider.html/"+obj.attr("proid"),
...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/jsp/queryprovider.html?method=view&proid="+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/jsp/updateprovider.html?method=modify&proid="+ obj.attr("proid");
	});
