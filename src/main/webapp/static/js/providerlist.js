...
function deleteProvider(obj){
	$.ajax({
		type:"GET",
		url:path+"/jsp/pro/delpro/"+obj.attr("proid"),
...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/jsp/pro/providerview/"+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/jsp/pro/providermodify/"+ obj.attr("proid");
	});
