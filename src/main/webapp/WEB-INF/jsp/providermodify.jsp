...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div class="providerAdd">
          <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/jsp/doupdateprovider.html">
              <!--div的class 为error是验证错误，ok是验证成功-->
              <input name="id" type="hidden" value="${provider.id}"/> <%--添加供应商id--%>
              <div class="">
