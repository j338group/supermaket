...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/jsp/bill.html">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/jsp/provider.html">供应商管理</a></li>
              <li><a href="${pageContext.request.contextPath }/jsp/userlist.html">用户管理</a></li>
