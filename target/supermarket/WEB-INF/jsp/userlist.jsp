...
<%@include file="common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="${pageContext.request.contextPath }/jsp/user/userlist.html">
					<input name="method" value="query" class="input-text" type="hidden">
					 ...
					 <a href="${pageContext.request.contextPath}/jsp/user/add.html" >添加用户</a>
				</form>
            </div>
            <!--用户-->
			...
			<input type="text" id="totalPageCount" value="${totalPageCount}"/>
